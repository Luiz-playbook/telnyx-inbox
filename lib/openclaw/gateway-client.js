...
// CONFIRMED against the live gateway: client.id and client.mode are strict enums —
// { id:"cli", mode:"cli" } is accepted and returns hello-ok. (id:"marketing-blaster" is rejected.)
